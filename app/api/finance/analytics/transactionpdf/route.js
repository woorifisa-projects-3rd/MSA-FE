...
export async function POST(request) {
    try {
        ...
        console.log("sping boot server에게 보낼 데이터",storeid, year, month)

        // Spring Boot 서버로 POST 요청
        const response = await springClient.post(`/finance/transactionpdf?storeid=${storeid}&year=${year}&month=${month}`
        );
